...
const forms = (state = { items: [], fetching: false, fetched: false }, action) => {
  switch (action.type) {
...
const formEntries = (state = { items: [], fetching: false, fetched: false }, action) => {
  switch (action.type) {
...
const entryFormData = (state = defaultEntryFormDataState, action) => {
  switch (action.type) {
